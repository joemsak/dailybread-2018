...
ActiveRecord::Schema.define(version: 2018_12_09_183426) do
  ...
  create_table "v1_incomes", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.integer "payroll_type", null: false
    t.string "specific_monthly"
    t.string "specific_weekly"
  ...
  create_table "v1_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "access_refresh_token", null: false
